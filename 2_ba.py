...
G_ori_1 = nx.read_gpickle('ba_ori.gpickle')
G_ori_2 = nx.read_gpickle('ba_ori.gpickle')
...
np.save('ba_E/l_ba_Es',l_ba_Es)
np.save('ba_E/nl_ba_Es',nl_ba_Es)
np.save('ba_E/l_ws_Es',l_ws_Es)
np.save('ba_E/nl_ws_Es',nl_ws_Es)
...
np.save('ba_E/nE_ba_l',nE_ba_l)
np.save('ba_E/nE_ba_nl',nE_ba_nl)
np.save('ba_E/nE_ws_l',nE_ws_l)
np.save('ba_E/nE_ws_nl',nE_ws_nl)
